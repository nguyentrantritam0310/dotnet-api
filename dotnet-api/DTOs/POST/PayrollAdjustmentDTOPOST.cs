...
{
    public class PayrollAdjustmentDTOPOST
    {
        ...
        public List<PayrollAdjustmentEmployeeDTOPOST> employees { get; set; } = new List<PayrollAdjustmentEmployeeDTOPOST>();
    }

    public class PayrollAdjustmentEmployeeDTOPOST
    {
