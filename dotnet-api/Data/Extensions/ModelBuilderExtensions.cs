...
namespace dotnet_api.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            // Seed data for Contract_Allowance
            modelBuilder.Entity<Contract_Allowance>().HasData(
                new Contract_Allowance
                {
                    ContractID = 1,
                    AllowanceID = 1,
                    Value = 500000
            ...
            );
            {
                ...
                var manager3User = new ApplicationUser
                {
                    ...
                    FirstName = "Lê",
                    LastName = "Xây Dựng",
                    birthday = new DateTime(1980, 1, 4),
                ...
                var workers = new List<ApplicationUser>
            {
                ...
                new ApplicationUser
                {
                    ...
                    FirstName = "Mai",
                    LastName = "Thị Hàn",
                    birthday = new DateTime(1995, 1, 2),
                    joinDate = new DateTime(2024, 1, 1),
                    Gender = "Nữ",
                    RoleID = 4,
                    Phone = "0989012345",
                ...
                new ApplicationUser
                {
                    ...
                    FirstName = "Trịnh",
                    LastName = "Công Mộc",
                    birthday = new DateTime(1995, 1, 4),
                    joinDate = new DateTime(2024, 1, 1),
                    Gender = "Nam",
                    RoleID = 4,
                    Phone = "0911223344",
        ...
        new Attendance
        {
            ...
            Status = AttendanceStatusEnum.Present
                ...
                modelBuilder.Entity<AdjustmentType>().HasData(
                    new AdjustmentType { ID = 1, AdjustmentTypeName = "Khen thưởng" },
                    new AdjustmentType { ID = 2, AdjustmentTypeName = "Tạm ứng" },
                    new AdjustmentType { ID = 3, AdjustmentTypeName = "Kỷ luật" },
                    new AdjustmentType { ID = 4, AdjustmentTypeName = "Truy thu" },
                    new AdjustmentType { ID = 5, AdjustmentTypeName = "Truy lãnh" }
                );

                // 2️⃣ AdjustmentItem – mỗi type vài item
                modelBuilder.Entity<AdjustmentItem>().HasData(
                    // Khen thưởng
                    new AdjustmentItem { ID = 1, AdjustmentItemName = "Thưởng năng suất", AdjustmentTypeID = 1 },
                    new AdjustmentItem { ID = 2, AdjustmentItemName = "Thưởng dự án", AdjustmentTypeID = 1 },

                    // Tạm ứng
                    new AdjustmentItem { ID = 3, AdjustmentItemName = "Tạm ứng lương", AdjustmentTypeID = 2 },
                    new AdjustmentItem { ID = 4, AdjustmentItemName = "Tạm ứng công tác phí", AdjustmentTypeID = 2 },

                    // Kỷ luật
                    new AdjustmentItem { ID = 5, AdjustmentItemName = "Đi trễ", AdjustmentTypeID = 3 },
                    new AdjustmentItem { ID = 6, AdjustmentItemName = "Nghỉ không phép", AdjustmentTypeID = 3 },

                    // Truy thu
                    new AdjustmentItem { ID = 7, AdjustmentItemName = "Truy thu bảo hiểm", AdjustmentTypeID = 4 },

                    // Truy lãnh
                    new AdjustmentItem { ID = 8, AdjustmentItemName = "Truy lãnh tăng lương", AdjustmentTypeID = 5 }
                );

                // 3️⃣ PayrollAdjustment – 3 phiếu cộng/trừ cho nhân viên tech1-id
                modelBuilder.Entity<PayrollAdjustment>().HasData(
                    new PayrollAdjustment
                    {
                        voucherNo = "PA-001",
                        decisionDate = new DateTime(2025, 9, 1),
                        Month = 9,
                        Year = 2025,
                    ...
                    {
                        voucherNo = "PA-002",
                        decisionDate = new DateTime(2025, 9, 5),
                        Month = 9,
                        Year = 2025,
                    ...
                    {
                        voucherNo = "PA-003",
                        decisionDate = new DateTime(2025, 9, 10),
                        Month = 9,
                        Year = 2025,
                ...
                // 4️⃣ Liên kết nhân viên – VALUE luôn dương
                modelBuilder.Entity<ApplicationUser_PayrollAdjustment>().HasData(
                    new ApplicationUser_PayrollAdjustment
                    {
                        PayrollAdjustmentID = "PA-001", // khóa chính chính là voucherNo
                        EmployeeID = "tech1-id",
                        Value = 2000000 // luôn ABS
                    },
                    new ApplicationUser_PayrollAdjustment
                    {
                ...
                modelBuilder.Entity<Allowance>().HasData(
                    new Allowance { ID = 1, AllowanceName = "Phụ cấp ăn trưa" },
                    new Allowance { ID = 2, AllowanceName = "Phụ cấp xăng xe" },
                    new Allowance { ID = 3, AllowanceName = "Phụ cấp điện thoại" }
                );

                // Seed data for FamilyRelation
                modelBuilder.Entity<FamilyRelation>().HasData(
                    new FamilyRelation { ID = 1, RelativeName = "Nguyễn Văn A", StartDate = new DateTime(2000, 1, 1), EndDate = new DateTime(2025, 1, 1) },
